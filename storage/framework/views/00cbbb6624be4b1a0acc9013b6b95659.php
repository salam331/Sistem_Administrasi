...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            <?php echo e(__('Riwayat Tagihan Saya')); ?>
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $tagihans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tagihan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400">
                                            <?php echo e(\Carbon\Carbon::parse($tagihan->tanggal_tagihan)->isoFormat('D MMM Y')); ?>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <?php if($tagihan->status == 'Lunas'): ?>
                                                <a href="<?php echo e(route('siswa.tagihan.show', $tagihan)); ?>"
...
<?php endif; ?><?php /**PATH D:\laragon\www\sistem_administrasi\resources\views/siswa/tagihan/index.blade.php ENDPATH**/ ?>