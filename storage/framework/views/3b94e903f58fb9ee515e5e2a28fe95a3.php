     ...
     <?php $__env->slot('header', null, []); ?> 
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            ...
            <?php elseif(Auth::user()->hasRole('siswa')): ?>
                - Siswa
            <?php elseif(Auth::user()->hasRole('orang_tua')): ?>
                - Orang Tua
            <?php endif; ?>
        </h2>
     <?php $__env->endSlot(); ?>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <?php echo $__env->make('admin.dashboard.partials.guru', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endif; ?>

                    
                    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'siswa')): ?>
                    <?php echo $__env->make('admin.dashboard.partials.siswa', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endif; ?>

                    
                    <?php if (\Illuminate\Support\Facades\Blade::check('role', 'orang_tua')): ?>
                    <?php echo $__env->make('admin.dashboard.partials.orang_tua', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                    <?php endif; ?>
...
<?php endif; ?><?php /**PATH D:\laragon\www\sistem_administrasi\resources\views/dashboard.blade.php ENDPATH**/ ?>